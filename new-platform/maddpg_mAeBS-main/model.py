...
class critic_agent(abstract_agent):
    def __init__(self, obs_shape_n, action_shape_n):
        ...
        self.linear_o_c1 = nn.Linear(obs_shape_n, 128)
        self.linear_a_c1 = nn.Linear(action_shape_n, 128)
        self.linear_c2 = nn.Linear(128 * 2, 64)
...
class openai_critic(abstract_agent):
    def __init__(self, obs_shape_n, action_shape_n):
        ...
        self.LReLU = nn.LeakyReLU(0.01)
        self.linear_c1 = nn.Linear(action_shape_n + obs_shape_n, 64)
